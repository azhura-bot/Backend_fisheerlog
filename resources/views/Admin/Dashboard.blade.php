                ...
                <div class="topbar-left">
                    <div class="text-center">
                        ...
                        <a href="Dashboard.html" class="logo">
                            <img src="assets/images/LogoFIs.png"  class="logo-large" height="500">
                        </a>
                    </div>
                </div>
                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            ...
                                            <p class="notify-details"><b>Pesan baru</b><small class="text-muted">Seseorang memperbarui data masuk</small></p>
                                        </a>
                                        <!-- All-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            View All
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                        ...
                                        <a class="dropdown-item" href="pages-login.html"><i class="mdi mdi-logout m-r-5 text-muted"></i> Logout</a>
                                    </div>
                                </li>
