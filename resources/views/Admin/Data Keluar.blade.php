                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Data Keluar</h4>
                                            ...
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-sm-2 col-form-label">Nama Pengirim</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="search" value="Masukkan Nama Pengirim" id="example-search-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
