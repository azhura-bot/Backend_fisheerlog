                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted mb-4 font-14">Tambahkan Modul dengan drop file disini atau upload.
                                            </p> 
                                            <div class="m-b-20">
                                            ...
                                            <div class="text-center m-t-15">
                                                <button type="button" href="Dashboard.html" class="btn btn-primary waves-effect waves-light">Kirim File</button>
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
