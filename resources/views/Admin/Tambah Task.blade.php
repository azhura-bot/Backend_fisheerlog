                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="example-datetime-local-input" class="col-sm-2 col-form-label">Tenggat Waktu</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="datetime-local" value="2011-08-19T13:45:00" id="example-datetime-local-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Judul Tugas</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" value="Masukkan Judul Tugas" id="example-text-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Deskripsi Tugas</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" value="Masukkan Judul Task" id="example-text-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-10 offset-sm-2">
                                                    <button  type="submit" href="Terkirim.html" class="btn btn-primary">Kirim Data</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
